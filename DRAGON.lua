...
if res ~= 200 then
print('\27[0;31m•━━━━━━━EVEN ━━━━━━•ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na•━━━━━━━EVEN ━━━━━━•ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m•━━━━━━━EVEN ━━━━━━•ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/HECTORa2/eivel/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,bot_id,1708278488,1707344582}   
...
if tonumber(user_id) == tonumber(1708278488) then  
var = true  
elseif tonumber(user_id) == tonumber(1707344582) then
var = true  
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'ايفن'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "CH_EVEN")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 ѕᴏụʀᴄᴇ ᴇɪᴠᴇʟ")  
...
os.execute('wget https://raw.githubusercontent.com/HECTOR/eivel/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ✿ تم تحديث السورس \n ✿ لديك اخر اصدار لسورس ايفن\n ✿ الاصدار ↝ { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✿ اصدار سورس ايفن \n ✿ الاصدار ↝{ v 1.5}')
end
if text == 'المفتيمبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV HECTOR](t.me/Uu_krl)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'H è Ꮯ Т ❍ R ', url="t.me/Uu_krl"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/CH_EVEN"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/Uu_krl25BOT)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩𝗧𝘄𝗮𝘀𝗼𝗹𓆪', url="t.me/Uu_krl25BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n ✿ العضو ↝ ['..result.title_..'](t.me/'..(username or 'CH_EVEN')..')'
status  = '\n ✿ تم ترقيته مطور'
...
usertext = '\n ✿ العضو ↝ ['..data.first_name_..'](t.me/'..(data.username_ or 'CH_EVEN')..')'
status  = '\n ✿ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✿ العضو ↝ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'CH_EVEN')..') \n ✿ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ✿ العضو : {["..data.first_name_.."](T.ME/CH_EVEN)}\n ✿ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✿ عذرا ↝ {["..data.first_name_.."](T.ME/CH_EVEN)}\n ✿ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/HECTORa2/eivel/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ✿ تم تحديث السورس \n ✿ لديك اخر اصدار لسورس ايفن\n ✿ الاصدار ↝ { v 1.5}')
dofile('DRAGON.lua')  
end
...
local Text = [[ 
[ѕᴏᴜʀᴄᴇ ᴇᴠɪʟ ](t.me/CH_EVEN)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '℘𝗛𝙀𝗖𝙏𝙊𝙍℘',url="t.me/Uu_krl"}}, 
{{text = '℘𝙀𝗟𝗠𝙊𝗙𝙏𝙔℘',url="t.me/s5sss1"}}, 
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙀𝗩𝙄𝗟', url="t.me/CH_EVEN"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/CH_EVEN&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐄𝐕𝐈𝐋 ✿
✿اهلا بك في سورس ايفن الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني ✿
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'H è Ꮯ Т ❍ R ',url="t.me/Uu_krl"}},
{{text = '𓆩𝗧𝘄𝗮𝘀𝗼𝗹𓆪',url="t.me/Uu_krl25BOT"}}, 
{{text = 'è Ł ḿ ❍ ℉ Т Ỳ',url="t.me/s5sss1"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩𝙨𝙤𝙪𝙧𝙘𝙚𓆪', url="t.me/CH_EVEN"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✿ بواسطه ↝ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'CH_EVEN')..') \n ✿ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✿ بواسطه ↝ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'CH_EVEN')..') \n ✿ تـم قفـل التاك بالكتم ')
end,nil)   
...
if result.sender_user_id_ == tonumber(1708278488) then
send(msg.chat_id_, msg.id_, " ✿ لا يمكنك حظر المبرمج هيكتور \n")
return false 
end
if result.sender_user_id_ == tonumber(1707344582) then
send(msg.chat_id_, msg.id_, " ✿  لا يمكنك حظر  المطور مفتي \n")
return false 
end
...
if result.sender_user_id_ == tonumber(1708278488) then
send(msg.chat_id_, msg.id_, " ✿ عيب ده بابا ★ \n")
return false 
end
if result.sender_user_id_ == tonumber(1707344582) then
send(msg.chat_id_, msg.id_, " ✿ عيب ده بابا ★ \n")
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://github.com/Hector532/hector/blob/main/DRAGON.lua")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✿ اهلا بك في متجر ملفات ايفن\n ✿ ملفات السورس ↓\n•━━━━━━━EVEN ━━━━━━•ٴ\n\n"
local TextE = "\n•━━━━━━━EVEN ━━━━━━•ٴ\n ✿ علامة تعني { ✔️ } ملف مفعل\n ✿ علامة تعني { ✖ } ملف معطل\n ✿ قناة سورس ايفن ↓\n".." ✿ [اضغط هنا لدخول](t.me/CH_EVEN) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/HECTORa2/eivel/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ✿ عذرا الملف لايدعم سورس ايفن \n") 
end
return false
end
...
if text == ("مسح قائمه ايفن") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ✿ تم مسح قائمه ايفن')
return false
end

if text == 'قائمه ايفن' and Sudo(msg) then
...
if text == ("رفع ايفن") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ايفن @(.*)$") and Sudo(msg) then
local username = text:match("^رفع ايفن @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ايفن (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع ايفن (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل ايفن") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ايفن @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ايفن @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ايفن (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ايفن (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------ adddev2 sudog
if text == ("رفع اخويا ") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
function Function_DRAGON(extra, result, success)
database:sadd(bot_id.."Dev:SoFi:2", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","✿تم ترقيته اخوك  في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
if text and text:match("^رفع اخويا  @(.*)$") and SudoBot(msg) then
local username = text:match("^رفع اخويا  @(.*)$")
function Function_DRAGON(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"✿ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
Reply_Status(msg,result.id_,"reply","✿تم ترقيته اخوك  في البوت")  
else
...
if text and text:match("^رفع اخويا  (%d+)$") and SudoBot(msg) then
local userid = text:match("^رفع اخويا  (%d+)$")
database:sadd(bot_id.."Dev:SoFi:2", userid)
Reply_Status(msg,userid,"reply","✿تم ترقيته اخوك  في البوت")  
return false 
end
if text == ("تنزيل اخويا ") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
function Function_DRAGON(extra, result, success)
database:srem(bot_id.."Dev:SoFi:2", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","✿ تم تنزيله من اخواتك")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
if text and text:match("^تنزيل اخويا  @(.*)$") and SudoBot(msg) then
local username = text:match("^تنزيل اخويا  @(.*)$")
function Function_DRAGON(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:SoFi:2", result.id_)
Reply_Status(msg,result.id_,"reply","✿ تم تنزيله من اخواتك")  
else
send(msg.chat_id_, msg.id_,"✿ لا يوجد حساب بهاذا المعرف")
end
end
...
if text and text:match("^تنزيل اخويا  (%d+)$") and SudoBot(msg) then
local userid = text:match("^تنزيل اخويا  (%d+)$")
database:srem(bot_id.."Dev:SoFi:2", userid)
Reply_Status(msg,userid,"reply","✿ تم تنزيله من اخواتك")  
return false 
end
if text == ("اخواتي") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
t = "\n✿ قائمه اخواتك في البوت  \n•━━━━━━━EVEN ━━━━━━•ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = "✿ لا يوجد اخوات انت لوحدك"
end
send(msg.chat_id_, msg.id_, t)
end
if text == ("مسح اخواتي") and SudoBot(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✿ لعضو ↝ ['..data.first_name_..'](t.me/'..(data.username_ or 'CH_EVEN')..')'
status  = '\n ✿ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✿ العضو ↝ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✿ العضــو ↝ ['..data.first_name_..'](t.me/'..(data.username_ or 'CH_EVEN')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✿ العضو ↝ ['..result.title_..'](t.me/'..(text1[3] or 'CH_EVEN')..')'..'\n ✿ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ايفن').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ايفن')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,""..ttt.."", msg.id_, msg.id_, "md") 
else 
send(msg.chat_id_, msg.id_,  ..ttt..  , 1,  md ) 
end 
end 
...
database:set(bot_id.."CH_EVEN:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."CH_EVEN:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."CH_EVEN:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."CH_EVEN:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✿تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."CH_EVEN:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."CH_EVEN:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس ايفن يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ايفن').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'CH_EVEN')..')'
local iduser = result.sender_user_id_
...
{
{text = '𝑠𝑜𝑢𝑟𝑐𝑒 𝑒𝑖𝑣𝑒𝑙', url="t.me/CH_EVEN"},
{text = 'مبرمج السورس', url="t.me/Uu_krl"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'•━━━━━━━EVEN ━━━━━━•ٴٴ\n✿ [ ѕᴏụʀᴄᴇ ᴇɪᴠᴇʟ ](t.me/CH_EVEN)')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ايفن')
